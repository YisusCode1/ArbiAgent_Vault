...
export const ActividadView: React.FC = () => {
  ...
  // Calculos dinamicos exactos de historial
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6 text-white font-sans">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 w-full md:w-auto">
          ...
          <div className="bg-[#0D1424] border border-cyan-900/20 px-4 py-2 rounded-xl">
            <div className="text-[10px] text-slate-400">Rendimiento total</div>
            <div className="text-lg font-bold text-emerald-400">+$0.14 USDC</div>
            <div className="text-[10px] text-slate-500">Generado en Aave</div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-[#0D1424] border border-cyan-900/20 p-4 rounded-xl">
        ...
        <button
          onClick={exportCSV}
          className="flex items-center gap-2 bg-[#070B14] border border-slate-800 hover:border-cyan-500/40 px-3 py-1.5 rounded-lg text-xs text-slate-300 transition-colors w-full sm:w-auto justify-center"
        >
      ...
      <div className="bg-[#070B14] border border-slate-800 rounded-lg p-3 flex items-center justify-between text-xs text-slate-400">
        <div className="flex items-center gap-2">
          ...
          <span><strong className="text-slate-200">MODO DEMO:</strong> Registro de eventos sincronizado con Arbitrum Sepolia.</span>
        </div>
